...
class CustomBaseMiner(ModuleWithRecordsAndDistance):
    ...
    def forward(self, embeddings, labels, scenes, ref_emb=None, ref_labels=None,ref_scenes=None):
        """
        Args:
        ...
        with torch.no_grad():
            ...
            mining_output = self.mine(
                embeddings=embeddings, ref_emb=ref_emb,
                scenes = scenes,
